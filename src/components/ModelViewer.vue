    ...
    <div class="tool-box" ref="toolBox">
      ...
      <div class="model-select">
        ...
        <a-space>
          <a-button
            shape="round"
            @click="initializeModel(0)"
            :class="{ 'active-model': currentModel == 0 }"
            ><i class="devicon-vuejs-plain"></i
          ></a-button>
          <a-button
            shape="round"
            @click="initializeModel(1)"
            :class="{ 'active-model': currentModel == 1 }"
      ...
      <div class="model-tools">
        ...
        <a-space class="model-tools-container">
          <a-button shape="round" @click="toggleAnimation">
            ...
            /></span>
            <span v-if="!isStop"
              ><pause-outlined :style="{ fontSize: '20px' }"
            /></span>
          </a-button>
          <a-button
            :class="{ 'active-model': !ishideGrid }"
            shape="round"
            @click="toggleGrid"
          >
          ...
          ></a-button>
          <a-button
            :class="{ 'active-model': !disableHints }"
            shape="round"
            @click="disableHints = !disableHints"
          >
  ...
  methods: {
    initializeModel(modelType) {
      nextTick(() => {
        ...
        renderer.setSize(
          this.$refs.modelCanvas.clientWidth,
          this.$refs.modelCanvas.clientWidth / 2
        );
